...
game_arg.add_argument('--demandDistribution', type=int, default=2, help='0=uniform, 1=normal distribution, 2=the sequence of 4,4,4,4,8,..., 3= basket data, 4= forecast data')
...
game_arg.add_argument('--ch1', type=float, default=1.0, help='holding cost of player 1')
game_arg.add_argument('--ch2', type=float, default=1.0, help='holding cost of player 2')
game_arg.add_argument('--ch3', type=float, default=1.0, help='holding cost of player 3')
game_arg.add_argument('--ch4', type=float, default=1.0, help='holding cost of player 4')
...
leadtimes_arg.add_argument('--leadRecItemLow', type=list, default=[1,1,1,1], help='the min lead time for receiving items')
leadtimes_arg.add_argument('--leadRecItemUp', type=list, default=[1,1,1,1], help='the max lead time for receiving items')
leadtimes_arg.add_argument('--leadRecOrderLow', type=int, default=[1,1,1,0], help='the min lead time for receiving orders')
leadtimes_arg.add_argument('--leadRecOrderUp', type=int, default=[1,1,1,0], help='the max lead time for receiving orders')
...
leadtimes_arg.add_argument('--leadRecItem1', type=int, default=1, help='the min lead time for receiving items')
leadtimes_arg.add_argument('--leadRecItem2', type=int, default=1, help='the min lead time for receiving items')
leadtimes_arg.add_argument('--leadRecItem3', type=int, default=1, help='the min lead time for receiving items')
leadtimes_arg.add_argument('--leadRecItem4', type=int, default=1, help='the min lead time for receiving items')
leadtimes_arg.add_argument('--leadRecOrder1', type=int, default=1, help='the min lead time for receiving order')
leadtimes_arg.add_argument('--leadRecOrder2', type=int, default=1, help='the min lead time for receiving order')
leadtimes_arg.add_argument('--leadRecOrder3', type=int, default=1, help='the min lead time for receiving order')
leadtimes_arg.add_argument('--leadRecOrder4', type=int, default=1, help='the min lead time for receiving order')
leadtimes_arg.add_argument('--ILInit1', type=int, default=10, help='the initial inventory level of the agent')
leadtimes_arg.add_argument('--ILInit2', type=int, default=10, help='the initial inventory level of the agent')
leadtimes_arg.add_argument('--ILInit3', type=int, default=10, help='the initial inventory level of the agent')
leadtimes_arg.add_argument('--ILInit4', type=int, default=10, help='the initial inventory level of the agent')
...
DQN_arg.add_argument('--gamma', type=float, default=.9, help='discount factor for Q-learning')
